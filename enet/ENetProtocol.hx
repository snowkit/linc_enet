...
from Int to Int {
    var ENET_PROTOCOL_COMMAND_FLAG_ACKNOWLEDGE = (1 << 7);
    var ENET_PROTOCOL_COMMAND_FLAG_UNSEQUENCED = (1 << 6);

    var ENET_PROTOCOL_HEADER_FLAG_COMPRESSED = (1 << 14);
    var ENET_PROTOCOL_HEADER_FLAG_SENT_TIME  = (1 << 15);
    var ENET_PROTOCOL_HEADER_FLAG_MASK       = (1 << 14) | (1 << 15);

    var ENET_PROTOCOL_HEADER_SESSION_MASK    = (3 << 12);
    var ENET_PROTOCOL_HEADER_SESSION_SHIFT   = 12;
} // ENetProtocolFlag
